...
document
  .getElementById("short-break-session")
  .addEventListener("click", () =>
    template_session(
      "#2A9D8F",
      "Time for a break!",
...
document
  .getElementById("long-break-session")
  .addEventListener("click", () =>
    template_session(
      "#A37ACE",
      "Extended break time!",
...
function template_session(
  color,
  session_message,
  [pomodoro_shadow, short_break_shadow, long_break_shadow],
  setTime
) {
