...
const settings_button = document
...
document.getElementById("settings-wrapper").addEventListener("click", (e) => {
  e.stopPropagation();
});

const settings_close_button = document
...
document
  .getElementById("pomodoro-length")
  .addEventListener("input", setPomodoroTime);
...
document
  .getElementById("short-break-length")
  .addEventListener("input", setShortBreakTime);
...
document
  ...
  .addEventListener("input", setLongBreakTime);
...
document
  .getElementById("long-break-count")
  .addEventListener("input", setLongBreakCount);
